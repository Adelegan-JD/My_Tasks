...
# TASK 3: Ask theuser for thier name and print "Hello, !" where is the user's input
...
print(statement[10:0:1])


# TASK 8: Given a string to reverse a string with extra spaces, remove the leading and trailing spaces
sentence = "            Nigeria         "
